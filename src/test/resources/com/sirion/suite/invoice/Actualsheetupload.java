...
public class Actualsheetupload extends TestSuiteBase {
	...
	public void ForecastsheetuploadTest(String FileName)throws InterruptedException, AWTException, IOException {
	    ...
	    Thread.sleep(20000);
	    driver.findElement(By.xpath("//a[contains(.,'ACTUALS')]")).click();
	    Thread.sleep(5000);
	...
	/*    StringSelection stringSelection = new StringSelection(System.getProperty("user.dir") +"//src//test//resources//com//sirion//xls//Actuals.xlsx");
	    ...
	    driver.findElement(By.xpath("//button[contains(.,'Browse')]")).sendKeys(System.getProperty("user.dir")+"//src//test//resources//com//sirion//xls//Actuals.xlsx");
	    
	      driver.findElement(By.xpath("//input[@value='Upload Actuals']")).click();
	       ...
	       Wait<WebDriver> wait1 = new FluentWait<WebDriver>(driver)
	    	   ...
	    	   wait1.until(new Function<WebDriver, WebElement>() {
	    	     public WebElement apply(WebDriver driver) {
	    	       ...
	    	       return driver.findElement(By.xpath("//td[contains(./text(),'Server')]"));
	    	     }
	    	   });
}
