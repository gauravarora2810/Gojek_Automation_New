...
public class IssueCreation extends TestSuiteBase
{
            ...
            String issueResponsibility) throws InterruptedException
    {
	    ...
	    wait.until(ExpectedConditions.elementToBeClickable(getObject("is_create_link_from_ac")));
	    getObject("is_create_link_from_ac").click(); // click issue create link 
       ...
       Thread.sleep(10000);
                       ...
                       getObject("ac_save_button").click();
                        ...
                        getObject("is_popup_ok_button_from_ac").click();
