...
public class ActionCreation extends TestSuiteBase {
  ...
  public void ActionCreation(String actionTitle, String actionDescription, String actionType, String actionPriority, String actionResponsibility,
      ...
      String actionStatus, String actionSupName, String actionSource, String actionSourceName, 
      String actionFunction, String actionService, String actionRegion, String actionCountry ) throws InterruptedException {
 ...
 wait.until(ExpectedConditions.elementToBeClickable(By.xpath(".//*[@id='mainContainer']/div/div[2]/a")));
	    ...
	    wait.until(ExpectedConditions.elementToBeClickable(getObject("ac_create_link_from_cr")));
 getObject("ac_create_link_from_cr").click(); // click issue create link 
