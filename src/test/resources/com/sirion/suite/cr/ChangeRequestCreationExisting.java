...

{
	...
	public void CRCreate(String crTitle, String crDescription, String crTimezone, String crClass, String crType, String crPriority,String crResponsibility, 
            ...
            String crSupplier, String crStatus, String crFunction, String crService, String conRegions, String conCountries) throws InterruptedException
	{
	    ...
	    wait.until(ExpectedConditions.elementToBeClickable(getObject("cr_create_link_from_cr")));
    
	    getObject("cr_create_link_from_cr").click(); // click issue create link 
