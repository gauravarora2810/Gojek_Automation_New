...
public class IssueNonWorkflow extends TestSuiteBase {
  ...
  @Test 
  public void IssueNonWorkflowTest() throws InterruptedException, ClassNotFoundException, SQLException {
	  ...
	  count++;
	    ...
	    if(getObject("is_popup_id")!=null){
	    	...
	    	System.out.println("Issue Id " + issueIdFromShowPage);
