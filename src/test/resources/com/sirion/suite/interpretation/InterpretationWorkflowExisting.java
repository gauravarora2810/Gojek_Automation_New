...
public class InterpretationWorkflowExisting extends TestSuiteBaseExisting {
  ...
  @Test 
	public void interpretationWorkflowTest() throws InterruptedException, ClassNotFoundException, SQLException
			 {
	    ...
	    if(getObject("ip_popup_id")!=null){
	    	...
	    	APP_LOGS.debug("IP Cloned successfully with Service Level id "+ip_id);
		...
		Assert.assertNotNull(driver.findElement(By.xpath("//button[contains(.,'Submit Query')]")));
		driver.findElement(By.xpath("//button[contains(.,'Submit Query')]")).click();
		Thread.sleep(10000);
         Assert.assertNotNull(driver.findElement(By.xpath("//button[contains(.,'Submit Clarification')]")));
         driver.findElement(By.xpath("//button[contains(.,'Submit Clarification')]")).click();
         Thread.sleep(10000);
