...
//import test.resources.com.sirion.suite.reports.childServiceLevel.TestSuiteBase;
import test.resources.com.sirion.util.TestUtil;

public class ChildServiceLevelCreation extends TestSuiteBase{
    ...
    public void SLCreationTest(
            ...
            String  slResponsibity, String  slFinancialImpactApplicable, String slCreditImpactApplicable, String contractTitleOp       
        ...
        APP_LOGS.debug("Executing Test Case Service Level Creation with title -- "+slTitle+ " under contract -- "+contractTitleOp);
        ...
        new Select (getObject("co_display_dropdown")).selectByIndex(3);
        driver.findElement(By.xpath(".//*[@id='cr']/tbody/tr[@role='row']/td[contains(.,'"+ contractTitleOp +"')]/preceding-sibling::td[1]/a")).click();
        Thread.sleep(10000);
...
/*                try
              ...
              APP_LOGS.debug("SL open successfully, following parameters have been validated: SL id -- " + sl_id);
