...
public class ActionCreation extends TestSuiteBase {
  ...
  public void ActionCreation(String actionSlName, String actionTitle, String actionDescription, String actionType, String actionPriority, String actionResponsibility,
 ...
 // Calling method for opening browser from TestBase.java file
       ...
       WebDriverWait wait=new WebDriverWait(driver, 50);
   		...
   		Thread.sleep(20000);
   		//wait.until(ExpectedConditions.elementToBeClickable(getObject("csl_id_link")));

   		getObject("csl_id_link").click(); 
   		
   		
   		

   		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(".//*[@id='mainContainer']/div/div[2]/a")));
       plus_button("csl_plus_button_link"); // web element for plus button on supplier page
       wait.until(ExpectedConditions.elementToBeClickable(getObject("ac_create_link_from_csl")));
       getObject("ac_create_link_from_csl").click(); // click issue create link  
