...
public class ChildServiceLevelListing extends TestSuiteBase {
  ...
  @Test 
	public void ChildServiceLevelListing() throws InterruptedException, ClassNotFoundException, SQLException
			 {
		...
		APP_LOGS.debug("Executing child Service Level listing query");
