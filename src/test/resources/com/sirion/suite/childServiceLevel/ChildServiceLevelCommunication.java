...
public class ChildServiceLevelCommunication extends TestSuiteBase

{
	 ...
	 String runmodes[]=null;
	    ...
	    public void slCommunicationTest(
	            ...
	            String  slResponsibity, String  slFinancialImpactApplicable, String slCreditImpactApplicable, String slComment,
...
//	                }
	                ...
	                String documentName=driver.findElement(By.xpath(".//*[@id='229']/tbody/tr/td[1]/a")).getText();
	                   System.out.println(documentName);
	                
	              if(documentName.equalsIgnoreCase(slUploadedFile))
	                {
	                	System.out.println("Document Name: "+ documentName +" in communication tab and "+ "File Name that we have uploaded in communication section i.e " + slUploadedFile +" are same");
	                }
	              
	              	String commentName=driver.findElement(By.xpath(".//*[@id='229']/tbody/tr/td[2]")).getText();
	              	System.out.println(commentName);
	              	if(commentName.equalsIgnoreCase(slComment))
	              	{
	              		System.out.println("Comment Name: "+ commentName +" in communication tab and "+ "Comment that we have entered in communication section i.e " + slComment +" are same");
	              	}
