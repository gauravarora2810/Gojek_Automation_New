...

{
	...
	public void CRCreate(
			String crSlName, String crTitle, String crDescription, String crTimezone, String crClass, String crType, String crPriority,String crResponsibility, 
            ...
            String crSupplier, String crStatus, String crFunction,String crService,String conRegions,String conCountries) throws InterruptedException
	{
		...
		openBrowser();
	       ...
	       wait.until(ExpectedConditions.elementToBeClickable(getObject("cr_create_link_from_csl")));
	       getObject("cr_create_link_from_csl").click(); // click issue create link  
