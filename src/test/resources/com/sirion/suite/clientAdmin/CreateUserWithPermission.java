...
public class CreateUserWithPermission extends TestSuiteBase

{
                ...
                public void UserCreation( String euLoginID,String select_all_check, String manual_permission_check,String group_permissions, String sub_group_permissions)  throws InterruptedException, ClassNotFoundException, SQLException 
...
//                                Thread.sleep(1000);
        ...
        driver.findElement(By.xpath(".//*[@id='proceed']")).click();                  
         ...
         if(select_all_check.equalsIgnoreCase("Y"))
         {
        	// selectAll();
         }
         if(manual_permission_check.equalsIgnoreCase("Y"))
         {
        	 //manualPermission();
         }
        // driver.close();   
