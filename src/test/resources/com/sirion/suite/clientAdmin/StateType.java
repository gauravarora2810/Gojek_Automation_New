...
public class StateType extends TestSuiteBase {
	...
	public void StateTypeCreation (String stateType) throws InterruptedException {
		count++;
		...
		getObject("ca_state_type_plus_button").click();

		getObject("ca_state_type_name_textbox").clear();
		getObject("ca_state_type_name_textbox").sendKeys(stateType);
