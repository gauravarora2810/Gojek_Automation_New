...
public class UpdateDepartment extends TestSuiteBase {
	...
	public void UpdateDepartmentTest (String departmentName, String departmentNameUpdate, String departmentBusinessUnitUpdate, String departmentActiveUpdate) throws InterruptedException {
		...
		APP_LOGS.debug("Executing Client Admin Department Update Test -- "+departmentNameUpdate);
		...
		if(driver.findElements(By.id("errorDialog")).size()!=0) {
			...
			APP_LOGS.debug("Department already exists with Name -- " +departmentNameUpdate);
        ...
        APP_LOGS.debug("Department opened successfully, and following parameters have been validated: Department Name -- " +departmentNameUpdate);
