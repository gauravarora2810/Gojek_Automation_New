...
public class POCreation extends TestSuiteBase  {
	...
	// Runmode of test case in a suite
		...
		public void checkTestSkip() {
			...
			if (!TestUtil.isTestCaseRunnable(po_suite_xls, this.getClass()
					.getSimpleName())) {
			...
			runmodes = TestUtil.getDataSetRunmodes(po_suite_xls, this
		...
		public Object[][] getTestData() {
			return TestUtil.getData(po_suite_xls, this.getClass()
					.getSimpleName());
		}
		}
