...
public class ServiceLevelEdit extends TestSuiteBase{
    ...
    public void SLCreationTest(
            ...
            String  slResponsibity, String  slFinancialImpactApplicable, String slCreditImpactApplicable, String slStatus, String slIdBeforeUpdate       
        ...
        APP_LOGS.debug("Executing Test Case Service Level update with id -- "+slIdBeforeUpdate);
        ...
        String sl_id = driver.findElement(By.xpath(".//*[@id='cr']/tbody/tr[@role='row']/td[contains(.,'"+ slIdBeforeUpdate +"')]/preceding-sibling::td[1]/a")).getText();
        
        driver.findElement(By.xpath(".//*[@id='cr']/tbody/tr[@role='row']/td[contains(.,'"+ slIdBeforeUpdate +"')]/preceding-sibling::td[1]/a")).click();
        Thread.sleep(10000);
        ...
        if(!slTitle.equalsIgnoreCase("")){    
          ...
          getObject("sl_id_textbox").clear(); // name
          getObject("sl_id_textbox").sendKeys(slid);
          }
          ...
          if(!slPageNumber.equalsIgnoreCase("")){ 
            ...
            Double temp_slPageNumber_double = Double.parseDouble(slPageNumber);
            int temp_slPageNumber_int = temp_slPageNumber_double.intValue();
            String slPageNumber_string = Integer.toString(temp_slPageNumber_int);
       
          getObject("sl_page_number_textbox").clear(); 
          getObject("sl_page_number_textbox").sendKeys(slPageNumber_string);
          }
...
*/
    ...
    */      
          ...
          if (!slResponsibity.equalsIgnoreCase("")) {
          ...
          if (slCreditImpactApplicable.equalsIgnoreCase("Yes")){
            getObject("sl_credit_imapct_applicable_checkbox").click();
                  ...
                  String SLIdShowPage= getObject("sl_id_show").getText();
                  try
                  {
                  Assert.assertEquals(SLIdShowPage, sl_id ,"SL id is= " +SLIdShowPage +"instead of" + sl_id);
                  }
                  catch(Throwable e)
                  {
                    System.out.println("SL id is= " +SLIdShowPage +"instead of" + sl_id);
                  } 
                  
                  String SLStatusShowPage= getObject("sl_status_show").getText();
                  try
                  {
                  Assert.assertEquals(SLStatusShowPage, slStatus ,"SL status is= " +SLStatusShowPage +"instead of" + slStatus);
                  }
                  catch(Throwable e)
                  {
                    System.out.println("SL status is= " +SLStatusShowPage +"instead of" + slStatus);
                  } 
                 ...
                 try
                  ...
                  try
                  {
                  Assert.assertEquals(SLDeliveryCountriesShowPage, slDeliveryCountries ,"SL Delivery Countries are= " +SLDeliveryCountriesShowPage +"instead of" + slDeliveryCountries);
                  }
                  catch(Throwable e)
                  {
                ...
                APP_LOGS.debug("SL edited successfully, following parameters have been validated: SL id -- " + sl_id);
