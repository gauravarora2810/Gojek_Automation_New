...
public class ServiceLevelCreation extends TestSuiteBase{
    ...
    public void SLCreationTest(
        ...
        APP_LOGS.debug("Executing Test Case Service Level Creation");
     ...
     // wait.until(ExpectedConditions.elementToBeClickable(getObject("ac_id_link")));
      ...
      wait.until(ExpectedConditions.elementToBeClickable(By.xpath(".//*[@id='mainContainer']/div/div[2]/a")));
        ...
        wait.until(ExpectedConditions.elementToBeClickable(getObject("sl_create_link_from_contract")));
      getObject("sl_create_link_from_contract").click(); // click issue create link 
       ...
       // WebElement datepicker_ui = driver.findElement(By.xpath(".//*[@id='ui-datepicker-div']"));
        ...
        Thread.sleep(10000);
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", getObject("sl_credit_applicable_checkbox"));
        ...
        Thread.sleep(10000);
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", getObject("sl_frequency_type_dropdown"));
        ...
        Thread.sleep(10000);
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", getObject("sl_responsibity_dropdown"));
