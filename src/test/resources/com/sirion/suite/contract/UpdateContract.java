...
public class UpdateContract extends TestSuiteBase {
...
@Test(groups = "ContractCreation", dataProvider = "getTestData")
  public void SOWContractsCreation(String contractName, String contractUpdateName, String contractTitle, String contractAgreement, 
		  ...
		  String contractMRegions, String contractMcountries, String contractRCS, String contractLRegions, String contractLCountries,
    ...
    APP_LOGS.debug(" Executing Test Case Contract Updation");
...
/*   getObject("contract_edit_button").click();
   ...
   try
        {
	   boolean localRegion = false;
	   if(getObject("co_local_region").getText() != null){
		   
		   String localregioncountrystructure = getObject("co_local_region").getText();
		   String localregion = getObject("co_local_reg").getText();
		   String localcountry = getObject("co_local_countries").getText();
		   APP_LOGS.debug("Local RCS is"+localregioncountrystructure+"Local Region is"+localregion+"Local Countries is"+localcountry);
	   }
        Assert.assertEquals(ContractMCountryShowPage, contractMcountries, "Contract Management Country is -- " +ContractMCountryShowPage+ " instead of -- " +contractMcountries);
        }
        catch(Throwable e)
        {
        	APP_LOGS.debug("Contract Management Country is -- " +ContractMCountryShowPage+ " instead of -- " +contractMcountries);
        }
    	String contractLRegionShowPage = getObject("co_l_region_show").getText();

    try
        {
     	   Assert.assertEquals(contractLRegionShowPage, contractLRegions, "Contract Local Region is -- " +contractLRegionShowPage+ " instead of -- " +contractLRegions);   
        }
        catch(Throwable e)
        {
        	APP_LOGS.debug("Contract Local Region is -- " +contractLRegionShowPage+ " instead of -- " +contractLRegions);
        }
