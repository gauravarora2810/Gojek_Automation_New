...
public class SOWContractCreationExisting extends TestSuiteBase {
...
@Test(groups = "ContractCreation", dataProvider = "getTestData")
  public void SOWContractsCreation(String parentContractName,String contractName,String contractTitle,String contractAgreement,
    ...
    driver.findElement(By.linkText("SOW")).click();
   ...
   if(!additionalTCV.equalsIgnoreCase("")){
    ...
    getObject("sow_save_button").click();
    Thread.sleep(60000);
    ...
    {
    	APP_LOGS.debug("Contract supplier is -- " +ContractSupplierShowPage+ " instead of -- " +contractSupName);
    }
    ...
    {
    	APP_LOGS.debug("Contract function is -- " +ContractFunctionShowPage+ " instead of -- " +contractFunction);
    }
    ...
    {
    	APP_LOGS.debug("Contract service is -- " +ContractServiceShowPage+ " instead of -- " +contractService);
    }
    ...
    {
    	APP_LOGS.debug("Contract region is -- " +ContractRegionShowPage+ " instead of -- " +contractRegion);
    }
    ...
    {
    	APP_LOGS.debug("Contract country is -- " +ContractCountryShowPage+ " instead of -- " +contractCountry);
    }
    ...
    {
    	APP_LOGS.debug("Contract TCV is -- " +ContractTCVShowPage+ " instead of -- " +contractTCV);
    }
    ...
    {
    	APP_LOGS.debug("Contract Additional TCV is -- " +ContractAddTCVShowPage+ " instead of -- " +contractAddTCV);
    }
    ...
    {
    	APP_LOGS.debug("Contract ACV is -- " +ContractACVShowPage+ " instead of -- " +contractACV);
    }
    ...
    {
    	APP_LOGS.debug("Contract Additional ACV is -- " +ContractAddACVShowPage+ " instead of -- " +contractAddACV);
    }
    ...
    {
    	APP_LOGS.debug("Contract FACV is -- " +ContractFACVShowPage+ " instead of -- " +contractFACV);
    }
    ...
    {
    	APP_LOGS.debug("Contract Additional FACV is -- " +ContractAddFACVShowPage+ " instead of -- " +contractAddFACV);
    }
