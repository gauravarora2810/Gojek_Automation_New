...
public class ContractMSACloneExisting extends TestSuiteBase {
...
@Test(groups = "ContractClone", dataProvider = "getTestData")
  public void ContractCloning(String Contract, String contractName, String contractTitle, String contractAgreement, 
		  ...
		  String contractExpirationMonth, String contractExpirationDate, String contractRegions, String contractCountries, 
    ...
    String ContractRegionShowPage = getObject("co_m_region_show").getText();
    try
    {
    ...
    String ContractCountryShowPage =getObject("co_m_countries_show").getText();
    try
    {
