...
public class IssueType extends TestSuiteBase {
	...
	public void IssueTypeCreation (String issueType, String issueTypeActive) throws InterruptedException {
		count++;
		...
		APP_LOGS.debug("Executing Sirion Admin Issue Type Creation Test -- "+issueType);
		...
		getObject("sa_issue_type_plus_button").click();
		
		getObject("sa_issue_type_name_textbox").clear();
		getObject("sa_issue_type_name_textbox").sendKeys(issueType);
		
		getObject("sa_issue_type_save_button").click();

		if(driver.findElements(By.id("errorDialog")).size()!=0) {
			String errors_create_page = getObject("sa_issue_type_notification_popup_errors_dialogue_box").getText();
			
			getObject("sa_issue_type_notification_popup_ok_button").click();
			
			getObject("sa_issue_type_cancel_button").click();
