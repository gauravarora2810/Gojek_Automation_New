...
public class SLSubCategory extends TestSuiteBase {
	...
	public void SLSubCategoryCreation (String slSubCategory, String slSubCategoryActive) throws InterruptedException {
		count++;
		...
		APP_LOGS.debug("Executing Sirion Admin SL Sub-Category Creation Test -- "+slSubCategory);
		...
		getObject("sa_sl_sub_category_plus_button").click();
		
		getObject("sa_sl_sub_category_name_textbox").clear();
		getObject("sa_sl_sub_category_name_textbox").sendKeys(slSubCategory);
		
		getObject("sa_sl_sub_category_save_button").click();

		if(driver.findElements(By.id("errorDialog")).size()!=0) {
			String errors_create_page = getObject("sa_sl_sub_category_notification_popup_errors_dialogue_box").getText();
			
			getObject("sa_sl_sub_category_notification_popup_ok_button").click();
			
			getObject("sa_sl_sub_category_cancel_button").click();
        ...
        new Select(getObject("sa_sl_sub_category_listing_page_display_dropdown")).selectByIndex(3);
        ...
        String entityTypeNameShowPage = getObject("sa_sl_sub_category_show_page_name").getText();
        Assert.assertEquals(entityTypeNameShowPage, slSubCategory, "SL Sub-Category Name at show page is -- " +entityTypeNameShowPage+ " instead of -- " +slSubCategory);
        
        String entityTypeActiveShowPage = getObject("sa_sl_sub_category_show_page_active").getText();
