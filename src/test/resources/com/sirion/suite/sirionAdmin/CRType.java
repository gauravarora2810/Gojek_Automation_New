...
public class CRType extends TestSuiteBase {
	...
	public void CRTypeCreation (String crType, String crTypeActive) throws InterruptedException {
		count++;
		...
		APP_LOGS.debug("Executing Sirion Admin CR Type Creation Test -- "+crType);
		...
		getObject("sa_cr_type_plus_button").click();
		
		getObject("sa_cr_type_name_textbox").clear();
		getObject("sa_cr_type_name_textbox").sendKeys(crType);
		
		getObject("sa_cr_type_save_button").click();

		if(driver.findElements(By.id("errorDialog")).size()!=0) {
			String errors_create_page = getObject("sa_cr_type_notification_popup_errors_dialogue_box").getText();
			
			getObject("sa_cr_type_notification_popup_ok_button").click();
