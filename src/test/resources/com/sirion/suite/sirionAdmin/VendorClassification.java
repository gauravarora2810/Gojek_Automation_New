...
public class VendorClassification extends TestSuiteBase {
	...
	public void VendorClassificationCreation (String vendorClassification, String vendorClassificationActive) throws InterruptedException {
		count++;
		...
		APP_LOGS.debug("Executing Sirion Admin Vendor Classification Creation Test -- "+vendorClassification);
		...
		getObject("sa_vendor_classification_plus_button").click();
		
		getObject("sa_vendor_classification_name_textbox").clear();
		getObject("sa_vendor_classification_name_textbox").sendKeys(vendorClassification);
		
		getObject("sa_vendor_classification_save_button").click();

		if(driver.findElements(By.id("errorDialog")).size()!=0) {
			String errors_create_page = getObject("sa_vendor_classification_notification_popup_errors_dialogue_box").getText();
			
			getObject("sa_vendor_classification_notification_popup_ok_button").click();
			
			getObject("sa_vendor_classification_cancel_button").click();
        ...
        String entityTypeActiveShowPage = getObject("sa_vendor_classification_show_page_active").getText();
