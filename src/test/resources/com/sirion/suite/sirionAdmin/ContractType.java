...
public class ContractType extends TestSuiteBase {
	...
	public void ContractTypeCreation (String contractType, String contractTypeActive) throws InterruptedException {
		count++;
		...
		APP_LOGS.debug("Executing Sirion Admin Contract Type Creation Test -- "+contractType);
		...
		getObject("sa_contract_type_plus_button").click();
		
		getObject("sa_contract_type_name_textbox").clear();
		getObject("sa_contract_type_name_textbox").sendKeys(contractType);
		
		getObject("sa_contract_type_save_button").click();

		if(driver.findElements(By.id("errorDialog")).size()!=0) {
			String errors_create_page = getObject("sa_contract_type_notification_popup_errors_dialogue_box").getText();
			
			getObject("sa_contract_type_notification_popup_ok_button").click();
			
			getObject("sa_contract_type_cancel_button").click();
        ...
        new Select(getObject("sa_contract_type_listing_page_display_dropdown")).selectByIndex(3);
        ...
        String entityTypeShowPage = getObject("sa_contract_type_show_page_name").getText();
        ...
        String entityTypeActiveShowPage = getObject("sa_contract_type_show_page_active").getText();
