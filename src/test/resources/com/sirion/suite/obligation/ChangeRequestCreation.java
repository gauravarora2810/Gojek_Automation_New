...
public class ChangeRequestCreation extends TestSuiteBaseExisting

{
            ...
            String crSupplier, String crStatus, String crFunction,String crService,String conRegions,String conCountries) throws InterruptedException
	{
	    ...
	    wait.until(ExpectedConditions.elementToBeClickable(getObject("cr_create_link_from_ob")));
    
	    getObject("cr_create_link_from_ob").click(); // click issue create link 
