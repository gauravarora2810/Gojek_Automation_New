...
public class ObligationCommunication extends TestSuiteBaseExisting{
...
//                }
                ...
                String documentName=driver.findElement(By.xpath(".//*[@id='329']/tbody/tr/td[1]/a")).getText();
                   System.out.println(documentName);
                
              if(documentName.equalsIgnoreCase(obUploadedFile))
                {
                	System.out.println("Document Name: "+ documentName +" in communication tab and "+ "File Name that we have uploaded in communication section i.e " + obUploadedFile +" are same");
                }
              
              	String commentName=driver.findElement(By.xpath(".//*[@id='329']/tbody/tr/td[2]")).getText();
