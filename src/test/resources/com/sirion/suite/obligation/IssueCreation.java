...
public class IssueCreation extends TestSuiteBaseExisting
{
    ...
    public void IssueCreate(
           String issueObligationName, String issueTitle, String issueDescription, String issueType, String issuePriority, String issueCurrencies,
            ...
            String issueResponsibility, String issueStatus, String issueSupName, String issueSource, String issueSourceName, String issueFunction, String issueService, String issueRegion, String issueCountry) throws InterruptedException
    {
     ...
     // Calling method for opening browser from TestBase.java file
     		...
     		WebDriverWait wait=new WebDriverWait(driver, 50);
      		...
      		//wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='rightLinks']/a[@href='/#/listRender/4']")));
     		//driver.findElement(By.xpath("//*[@id='rightLinks']/a[@href='/#/listRender/4']")).click();
     	    ...
     	    wait.until(ExpectedConditions.elementToBeClickable(getObject("is_create_link_from_ob")));
         
     	    getObject("is_create_link_from_ob").click(); // click issue create link 
